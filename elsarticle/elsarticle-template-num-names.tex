...
\begin{figure}[t]
    ...
    \caption{NASA's Lunar Gateway (Artemis Program)}\label{fig2a}
\end{figure}
...
\begin{figure}[t]
    ...
    \caption{Realms of Possible Motion for different Jacobi Constant $E$}\label{fig5}
\end{figure}
...
The characteristic length of any fragment is given by the relation:

\begin{equation}
    L_c = \frac{1}{3} (X + Y + Z)
\end{equation}

Based on this, we may obtain the size distribution of fragments from an explosion and collision event respectively given by:
